package com.liteon.jt808;

import com.liteon.javacint.logging.Logger;
import com.liteon.jt808.conn.Connection;
import com.liteon.jt808.conn.ConnectionConfiguration;
import com.liteon.jt808.conn.ConnectionStateCallback;
import com.liteon.jt808.conn.MessageListener;
...
public class JT808Client implements ConnectionStateCallback{
    ...
    public void connect(String host, int port, ClientStateCallback stateCallback){
        Logger.log(TAG + "  connect: " + host +":" +  port );
    ...
    public void registerClient(RegisterRequest registerRequest){
        Logger.log(TAG + "  registerClient " + registerRequest);
    ...
    public void authenticate(String authCode){
        Logger.log(TAG + "  authenticate " + authCode);
    ...
    private MessageListener mRegisterMsgListener =  new MessageListener(){
        ...
        public void processMessage(Message msg) {
            Logger.log(TAG + "  processMessage: msg=" + msg);
