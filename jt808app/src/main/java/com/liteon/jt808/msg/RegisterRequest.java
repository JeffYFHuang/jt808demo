...
import com.liteon.jt808.Jtt415Constants;
  ...
  public static class Builder extends MessageBuilder {
    ...
    public Builder mfrsId(byte[] id) {
      if (id != null && id.length == 5) {
        ...
        Logger.log(TAG + "  mfrsId: Illegal manufacturer ID, use default.");
      }
    ...
    public Builder cltModel(byte[] model) {
      if (model != null && model.length == 20) {
        ...
        Logger.log(TAG + "  cltModel: Illegal client model, use default.");
      }
    ...
    public Builder cltId(byte[] id) {
      if (id != null && id.length == 7) {
        ...
        Logger.log(TAG + "  cltId: Illegal client ID, use default.");
      }
    ...
    public Builder plateColor(byte color) {
      switch (color) {
        ...
        case Jtt415Constants.PLATE_COLOR_TEST:
          ...
          break;
        default:
          Logger.log(TAG + "  plateColor: Unknown plate color, use default.");
      }
    ...
    public Builder plateText(String text) {
      if (text != null) {
        ...
        Logger.log(TAG + "  plateText: Plate text is null, use default.");
      }
    ...
    public RegisterRequest build() {
      try {
        ...
        Logger.log(TAG + "  build: Encode message body failed." + uee);
      }
