...
//        break;
//      default:
//        Logger.log(TAG + "  authenticate: No such algorithm - " + algorithm);
//        return false;
//    }
//
//    short sKeyIdx = challenge.getSvrKeyIndex();
//    if (sKeyIdx < 0 || sKeyIdx >= SVR_KEYS.length) {
//      Logger.log(TAG + "  authenticate: Sever key " + sKeyIdx + " not found.");
//      return false;
//    }
//    String svrKey = SVR_KEYS[sKeyIdx];
//    Logger.log(TAG + "  authenticate: svrKey=" + svrKey + ", " + sKeyIdx);
//
//    short cKeyIdx = challenge.getCltKeyIndex();
//    if (cKeyIdx < 0 || cKeyIdx >= CLT_KEYS.length) {
//      Logger.log(TAG + "  authenticate: Client key " + cKeyIdx + " not found.");
//      return false;
//    }
//    String cltKey = CLT_KEYS[cKeyIdx];
//    Logger.log(TAG + "  authenticate: cltKey=" + cltKey + ", " + cKeyIdx);
//
//    try {
//      byte[] rdmA = CryptoUtils.decrypt(challenge.getEncryptedRdmA(), svrKey);
//      Logger.log(TAG + "  authenticate: rdmA=" + new String(rdmA, "ascii"));
//      byte[] rdmB = "aaaaaaaaaaaaaaaa".getBytes("ascii");
//      Logger.log(TAG + "  authenticate: rdmB=aaaaaaaaaaaaaaaa");
//
...
//      Logger.log(TAG + "  authenticate: Encode failed.", uue);
//    } catch (InvalidKeyException | BadPaddingException | IllegalBlockSizeException e) {
//      Logger.log(TAG + "  authenticate: Encryption failed.", e);
//      return false;
//    }
